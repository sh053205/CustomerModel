...
public class OrcWriter {
	private final static String testStruct = "struct<name:string,age:int>";
	public static void main(String[] args) throws Exception {		
		JobConf conf = new JobConf();
		FileSystem fs = FileSystem.get(conf);
		Path outputPath = new Path("/user/hadoop/SH/orc_test/");
		TypeInfo personTypeInfo = TypeInfoUtils.getTypeInfoFromTypeString(testStruct);
		ObjectInspector inspector = TypeInfoUtils.getStandardJavaObjectInspectorFromTypeInfo(personTypeInfo);
