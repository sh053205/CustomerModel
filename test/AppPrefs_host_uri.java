...
public class AppPrefs_host_uri {
	...
	private static class ExtractorReducer extends
		...
		protected void reduce(Text key, Iterable<IntWritable> values, Context context)
			...
			row = orcSerde.serialize(new AppPrefsRow_host_uri(result), inspector);
	...
	public static void main(String[] args) throws IOException,
		...
		Job job = Job.getInstance(conf, "App Preferences host+uri");
		job.setJarByClass(AppPrefs_host_uri.class);
